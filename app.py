...
<style>
    ...
    html, body, .main, .block-container {
        background-color: #efe0ff !important;  /* Slightly darker than #f5e8ff */
        color: #000000;
    ...
    [data-testid="stSidebar"] {
        background:  background: linear-gradient(135deg, #ffd700, #ffcc00, #fff8dc, #ffcc00, #ffd700);
...
if page == "Overview":
    ...
    with tab1:
        ...
        The Local Food Wastage Management System is an innovative platform designed to tackle the issue of surplus food disposal in urban settings.

        It connects food donors like restaurants, canteens, hostels, and event organizers with NGOs and underprivileged communities in need. The system facilitates timely and efficient food redistribution while promoting sustainability and social responsibility.
        """)

    with tab2:
        st.markdown("""
        ### Project Objective
        - Promote responsible consumption and reduce food wastage.
        - Create a transparent, accountable, and real-time food donation process.
        - Support NGOs, shelters, and communities with accessible food resources.
        - Align with **SDG Goal 12: Responsible Consumption and Production**.
        """)

    with tab3:
        st.markdown("""
        ### 📦 Modules
        - **Provider & Receiver Registration**  
          Secure and structured onboarding of food donors and beneficiaries.
        
        - **Food Listings & Claims**  
          Allows providers to list surplus food and receivers to claim it in real-time.
        
        - **Real-time SQL Dashboard**  
          Query food-related data live using dynamic SQL interactions.
        
        - **Data Visual Analytics**  
          Graphical insights into food distribution, expiry tracking, claims, etc.
        
        - **Contact & Support**  
          Help and support access for all stakeholders.
        """)
    ...
    with tab4:
        ...
        - **Streamlit**  – Frontend dashboard and interaction layer  
        - **PostgreSQL**  – Relational database for structured food data  
        - **Pandas & Plotly**  – Data handling and interactive charting  
        """)

# Styled captioned image with container using st.container()
    import base64
     ...
     st.markdown(
        ...
        '>
            ...
            <p style='
                ...
                font-style: italic;
            '>
                A local initiative for food redistribution and waste reduction.
            </p>
        </div>
        """,
        unsafe_allow_html=True
...
📍 Coimbatore, India  
📧 gayathri1429@gmail.com  
📞 +91 6374769587  
🔗 [LinkedIn](https://www.linkedin.com/in/gayathri-s-423a3a362/) | [GitHub](https://github.com/GayathriS1429)
        """)
...
- **MCA – Coimbatore Institute of Technology (2024–2026)**  
  CGPA: 9.365 / 10 *(Till 2nd semester)*

- **B.Sc. in Computer Technology – KG College of Arts and Science (2021–2024)**  
  CGPA: 9.179 / 10  
  🥇 *University 1st Rank Holder*

- **HSC – Vidyaa Vikas Matric Girls Higher Secondary School**  
  Percentage: 90.4%
        """)
...
- 🥇 **University 1st Rank Holder** – Bharathiar University  
